...
<body>
    ...
    <main>
        ...
        <div class="card01">
            <div class="card">
                <form action="{{ route('itens_pedido.update', $itpedido->id_itens_pedido) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-cont">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$itpedido->qtd_itens_pedido}}" name="qtd_itens_pedido" required>
                        </div>
                        <div class="form-group">
                            <label>preco_unitario:</label>
                            <input type="text" value="{{$itpedido->preco_unitario}}" name="preco_unitario" required>
                        </div>
